...
export class ProductService {
  ...
  private Products: Product[] = [
    ...
    { productId: 336, categoryName: 'makarnalar', productName: 'Çıtır Mantı', description: 'Haşlanmış dana etli mantılar, derin yağda kızarmış şekilde sarımsaklı yoğurt ve tereyağlı özel sos ile servis edilir.', tooltip: 'Yeni', price: 360, image: 'çıtır-mantı.jpg' },
    { productId: 337, categoryName: 'makarnalar', productName: 'Ev Mantısı', description: 'Haşlanmış dana etli mantılar, sarımsaklı yoğurt ve tereyağlı özel sos ile servis edilir.', tooltip: 'Yeni', price: 360, image: 'ev-mantısı.jpg' },
    { productId: 338, categoryName: 'makarnalar', productName: 'Körili Tavuklu Mantarlı Makarna', description: 'Haşlanmış penne makarnası, jülyen tavuk dilimleri, jülyen mantar, körili kremalı özel sos ile servis edilir.', tooltip: 'Yeni', price: 360, image: 'pesto-soslu-mantarlı-tavuklu-penne-makarna.jpg' },
