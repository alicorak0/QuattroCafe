...
export class ProductService {
  ...
  private products: Product[] = [
    ...
    { productId: 6, categoryName: 'kahvaltı', productName: 'Sıcak Kahvaltı', description: '', tooltip: 'En çok satan', price: 0, image: 'sıcak-kahvaltı.jpg' },
    ...
    { productId: 9, categoryName: 'burgerler', productName: 'Miami Burger', description: 'Izgara burger köftesi, karamelize soğan, mayonezli isli köz patlıcan, rosebeef dilimleri yanında patates cips ve dip sos ile servis edilir.', tooltip: 'En çok satan', price: 460, image: 'sıcak-kahvaltı.jpg' },
    ...
    { productId: 29, categoryName: 'gozlemeler', productName: 'Alaturka Gözleme', description: 'Taze yufka arasında rende kaşar peyniri, sucuk ve renkli biberler, yanında söğüş(domates,salatalık,zeytin),  patates cips ve dip sos ile servis edilir.', tooltip: 'En çok satan', price: 290, image: 'alaturka-gözleme.jpg' },
    { productId: 30, categoryName: 'gozlemeler', productName: 'Bolu Usulü Gözleme', description: 'Taze yufka arasında rende kaşar peyniri, kıyma, köz patlıcan, yanında söğüş(domates,salatalık,zeytin) , patates cips ve dip sos ile servis edilir.', tooltip: 'En çok satan', price: 350, image: 'bolu-usülü-gözleme.jpg' },

    { productId: 31, categoryName: 'atistirmalikler', productName: 'Karışık Sepet', description: 'Sigara böreği, sosis, soğan halkası, çıtır tavuk, patates cips ve dip sos ile servis edilir.', tooltip: 'En çok satan', price: 295, image: 'karışık-sepet-atıştırmalık.jpg' },
    { productId: 32, categoryName: 'atistirmalikler', productName: 'Çıtır Tavuk', description: 'Kızarmış paneli çıtır tavuk parçaları, patates cips ve dip sos ile servis edilir.', tooltip: 'En çok satan', price: 230, image: 'çıtır-tavuk-atıştırmalık.jpg' },
    { productId: 33, categoryName: 'atistirmalikler', productName: 'Bonfrit', description: 'Kızarmış baharatlı parmak patatesler, dip sos ile servis edilir.', tooltip: 'En çok satan', price: 180, image: 'patates-atıştırmalık.jpg' },
    { productId: 34, categoryName: 'atistirmalikler', productName: 'Soğan Halkası', description: 'Panelenmiş çıtır soğan, patates cips ve dip sos ile servis edilir.', tooltip: 'En çok satan', price: 220, image: 'soğan-halkası-atıştırmalık.jpg' },

    { productId: 35, categoryName: 'mesrubatlar', productName: 'Coca Cola', description: 'Buz gibi servis edilen ferahlatıcı kola.', tooltip: 'En çok satan', price: 60, image: 'içecekler-1.jpg' },
    { productId: 36, categoryName: 'mesrubatlar', productName: 'Fanta', description: 'Portakal aromalı, serinletici gazlı içecek.', tooltip: 'En çok satan', price: 60, image: 'içecekler-2.jpg' },
    { productId: 37, categoryName: 'mesrubatlar', productName: 'Schweppes', description: 'Kendine özgü aromasıyla ferahlatıcı gazlı içecek.', tooltip: 'En çok satan', price: 60, image: 'içecekler-3.jpg' },
    { productId: 38, categoryName: 'mesrubatlar', productName: 'Fuse Tea Mango', description: 'Egzotik mango aromalı soğuk çay.', tooltip: 'En çok satan', price: 60, image: 'içecekler-4.jpg' },
    { productId: 39, categoryName: 'mesrubatlar', productName: 'Fuse Tea Karpuz', description: 'Yaz ferahlığı sunan karpuz aromalı soğuk çay.', tooltip: 'En çok satan', price: 40, image: 'içecekler-5.jpg' },
    { productId: 41, categoryName: 'mesrubatlar', productName: 'Fuse Tea Şeftali', description: 'Doğal şeftali aromasıyla hafif ve ferah.', tooltip: 'En çok satan', price: 60, image: 'içecekler-6.jpg' },
    { productId: 42, categoryName: 'mesrubatlar', productName: 'Fuse Tea Limon', description: 'Limon aromalı, serinletici soğuk çay.', tooltip: 'En çok satan', price: 60, image: 'içecekler-7.jpg' },
    ...
    { productId: 44, categoryName: 'gozlemeler', productName: 'Peynirli Gözleme', description: 'Taze yufka arasında rende tulum peyniri, yanında söğüş(domates, salatalık, zeytin), patates cips ve dip sos ile servis edilir.', tooltip: 'En çok satan', price: 225, image: 'nophoto.jpg' },
    { productId: 45, categoryName: 'gozlemeler', productName: 'Kaşarlı Gözleme', description: 'Taze yufka arasında rende kaşar peyniri yanında söğüş(domates, salatalık, zeytin), patates cips ve dip sos ile servis edilir.', tooltip: 'En çok satan', price: 250, image: 'nophoto.jpg' },
    { productId: 46, categoryName: 'gozlemeler', productName: 'Mantarlı Kaşarlı Gözleme', description: 'Taze yufka arasında rende kaşar peyniri ve mantar dilimleri yanında söğüş(domates,salatalık,zeytin), patates cips ve dip sos ile servis edilir.', tooltip: 'En çok satan', price: 275, image: 'nophoto.jpg' },
    ...
    { productId: 51, categoryName: 'atistirmalikler', productName: 'Sigara Böreği', description: 'Kızarmış sigara börekleri, patates cips ve dip sos ile servis edilir.', tooltip: 'En çok satan', price: 220, image: 'nophoto.jpg' },
    ...
    { productId: 64, categoryName: 'sicak-kahveler', productName: 'Americano', description: 'Espresso bazlı, sade ve dengeli içimli sıcak kahve.', tooltip: 'Yeni', price: 150, image: 'nophoto.jpg' },
    { productId: 65, categoryName: 'sicak-kahveler', productName: 'Butter Caramel', description: 'Tereyağlı karamel aromasıyla yumuşak ve tatlı içim.', tooltip: 'Yeni', price: 200, image: 'nophoto.jpg' },
    { productId: 66, categoryName: 'sicak-kahveler', productName: 'Cappuccino', description: 'Bol köpük ve yoğun espresso tadıyla klasik cappuccino.', tooltip: 'Yeni', price: 200, image: 'nophoto.jpg' },
    { productId: 67, categoryName: 'sicak-kahveler', productName: 'Caramel Latte', description: 'Karamel dokunuşlu latte; kremamsı ve tatlı içim.', tooltip: 'Yeni', price: 180, image: 'nophoto.jpg' },
    { productId: 68, categoryName: 'sicak-kahveler', productName: 'Caramel Macchiato', description: 'Espresso ve sütün karamel ile katmanlı, aromalı buluşması.', tooltip: 'Yeni', price: 180, image: 'nophoto.jpg' },
    { productId: 69, categoryName: 'sicak-kahveler', productName: 'Cookie Latte', description: 'Kurabiye aromasıyla tatlı, yumuşak içimli latte.', tooltip: 'Yeni', price: 180, image: 'nophoto.jpg' },
    { productId: 70, categoryName: 'sicak-kahveler', productName: 'Cortado', description: 'Espresso ve az sütle dengelenmiş, yoğun aromalı içim.', tooltip: 'Yeni', price: 160, image: 'nophoto.jpg' },
    { productId: 71, categoryName: 'sicak-kahveler', productName: 'Espresso', description: 'Kısa, yoğun ve aroması yüksek klasik espresso.', tooltip: 'Yeni', price: 80, image: 'nophoto.jpg' },
    { productId: 72, categoryName: 'sicak-kahveler', productName: 'Double Espresso', description: 'Daha yoğun kahve deneyimi için çift shot espresso.', tooltip: 'Yeni', price: 100, image: 'nophoto.jpg' },
    { productId: 73, categoryName: 'sicak-kahveler', productName: 'Flat White', description: 'Kadifemsi süt dokusu ve yoğun espresso dengesi.', tooltip: 'Yeni', price: 170, image: 'nophoto.jpg' },
    { productId: 74, categoryName: 'sicak-kahveler', productName: 'Hazelnut Latte', description: 'Fındık aromasıyla zenginleşen kremalı latte.', tooltip: 'Yeni', price: 180, image: 'nophoto.jpg' },
    { productId: 75, categoryName: 'sicak-kahveler', productName: 'Irish Latte', description: 'İrish aromasıyla sıcak, yumuşak içimli latte.', tooltip: 'Yeni', price: 180, image: 'nophoto.jpg' },
    { productId: 76, categoryName: 'sicak-kahveler', productName: 'Latte', description: 'Espresso ve sütün klasik uyumu; kremamsı içim.', tooltip: 'Yeni', price: 170, image: 'nophoto.jpg' },
    { productId: 77, categoryName: 'sicak-kahveler', productName: 'Lotus Latte', description: 'Lotus aromasıyla tatlı ve yumuşak içimli latte.', tooltip: 'Yeni', price: 180, image: 'nophoto.jpg' },
    { productId: 78, categoryName: 'sicak-kahveler', productName: 'Mocha', description: 'Kahve ve çikolatanın sıcak, yoğun birleşimi.', tooltip: 'Yeni', price: 180, image: 'nophoto.jpg' },
    { productId: 79, categoryName: 'sicak-kahveler', productName: 'Salted Caramel', description: 'Tuzlu karamel aromasıyla dengeli tatlı bir latte.', tooltip: 'Yeni', price: 200, image: 'nophoto.jpg' },
    { productId: 80, categoryName: 'sicak-kahveler', productName: 'Vanilya Latte', description: 'Vanilya aromasıyla yumuşak ve tatlı içim.', tooltip: 'Yeni', price: 180, image: 'nophoto.jpg' },
    { productId: 81, categoryName: 'sicak-kahveler', productName: 'White Mocha', description: 'Beyaz çikolata dokunuşlu, kremamsı mocha.', tooltip: 'Yeni', price: 185, image: 'nophoto.jpg' },
    { productId: 82, categoryName: 'sicak-kahveler', productName: 'Almond Latte', description: 'Badem aromasıyla hafif ve tatlı latte deneyimi.', tooltip: 'Yeni', price: 200, image: 'nophoto.jpg' },
    { productId: 83, categoryName: 'sicak-kahveler', productName: 'Choco-Banana', description: 'Çikolata ve muz aromasıyla tatlı, sıcak içim.', tooltip: 'Yeni', price: 200, image: 'nophoto.jpg' },
    { productId: 84, categoryName: 'sicak-kahveler', productName: 'Cocoster Latte', description: 'Hindistan cevizi aromasıyla yumuşak içimli latte.', tooltip: 'Yeni', price: 200, image: 'nophoto.jpg' },
    { productId: 85, categoryName: 'sicak-kahveler', productName: 'Pumpkin Spice Latte', description: 'Baharatlı balkabağı aromasıyla sıcak ve karakterli içim.', tooltip: 'Yeni', price: 200, image: 'nophoto.jpg' },
    { productId: 86, categoryName: 'sicak-kahveler', productName: 'Quattro Latte', description: 'Özel Quattro dokunuşuyla aromalı latte.', tooltip: 'Yeni', price: 200, image: 'nophoto.jpg' },

    { productId: 87, categoryName: 'tatlilar', productName: 'Belçika Çikolatalı Pasta', description: 'Yoğun Belçika çikolatası ile zengin, yumuşak pasta dilimi.', tooltip: 'Yeni', price: 260, image: 'nophoto.jpg' },
    { productId: 88, categoryName: 'tatlilar', productName: 'Bellavista', description: 'Kremamsı dokusu ve hafif tadıyla özel tatlı seçeneği.', tooltip: 'Yeni', price: 220, image: 'nophoto.jpg' },
    { productId: 89, categoryName: 'tatlilar', productName: 'Antep Cup', description: 'Antep fıstığı aromalı cup tatlı; pratik ve lezzetli.', tooltip: 'Yeni', price: 230, image: 'nophoto.jpg' },
    { productId: 90, categoryName: 'tatlilar', productName: 'Black Velvet Cup', description: 'Kakao aromalı, yumuşak dokulu velvet cup tatlı.', tooltip: 'Yeni', price: 220, image: 'nophoto.jpg' },
    { productId: 91, categoryName: 'tatlilar', productName: 'Devil Mono Pasta', description: 'Yoğun çikolata severlere özel, tek porsiyon mono pasta.', tooltip: 'Yeni', price: 280, image: 'nophoto.jpg' },
    { productId: 92, categoryName: 'tatlilar', productName: 'Frambuaz Cheesecake', description: 'Frambuaz aromasıyla ferah, kremalı cheesecake dilimi.', tooltip: 'Yeni', price: 240, image: 'nophoto.jpg' },
    { productId: 93, categoryName: 'tatlilar', productName: 'Limon Cheesecake', description: 'Limonun ferahlığıyla hafif ve kremalı cheesecake.', tooltip: 'Yeni', price: 240, image: 'nophoto.jpg' },
    { productId: 94, categoryName: 'tatlilar', productName: 'Lotus Cheesecake', description: 'Lotus aromasıyla zengin, yoğun lezzette cheesecake.', tooltip: 'Yeni', price: 240, image: 'nophoto.jpg' },
    { productId: 95, categoryName: 'tatlilar', productName: 'Magnolia Cup', description: 'Kremalı magnolia; bisküvi dokusuyla keyifli tatlı.', tooltip: 'Yeni', price: 220, image: 'nophoto.jpg' },
    { productId: 96, categoryName: 'tatlilar', productName: 'San Sebastian', description: 'Karamelize üst yüzeyiyle klasik San Sebastian cheesecake.', tooltip: 'Yeni', price: 240, image: 'nophoto.jpg' },
    { productId: 97, categoryName: 'tatlilar', productName: 'Yaban Mersinli Cheesecake', description: 'Yaban mersini aromasıyla meyveli, kremalı cheesecake.', tooltip: 'Yeni', price: 240, image: 'nophoto.jpg' },
    { productId: 98, categoryName: 'tatlilar', productName: 'Latte Pasta', description: 'Kahve aromalı, yumuşak ve dengeli pasta dilimi.', tooltip: 'Yeni', price: 260, image: 'nophoto.jpg' },
    { productId: 99, categoryName: 'tatlilar', productName: 'Antep San Sebastian', description: 'Antep fıstığı dokunuşlu San Sebastian; yoğun ve özel.', tooltip: 'Yeni', price: 290, image: 'nophoto.jpg' },
    { productId: 100, categoryName: 'tatlilar', productName: 'Antep Rüyası', description: 'Antep fıstığı ağırlıklı, zengin aromalı özel tatlı.', tooltip: 'Yeni', price: 280, image: 'nophoto.jpg' },
